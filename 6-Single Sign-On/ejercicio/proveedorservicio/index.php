...
?>
				...
				<!-- Formulario que llama a script que llama a su vez al sso de su usuario logeado -->
				<form method="get" action="http://localhost:8080/prueba/ejercicio/proveedoridentidad/login.php">
